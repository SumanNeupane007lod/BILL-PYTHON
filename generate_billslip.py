...
import random
root=Tk()
root.title("Suman Billing System")
root.geometry('1280x720')
bg_color='#4D3039'

#======================variable=======By>>Suman007lod==========
c_name=StringVar()
c_phone=StringVar()
item=StringVar()
Rate=IntVar()
...
def welcome():
    ...
    textarea.insert(END,"\t  Welcome Suman shop ")
...
title=Label(root,pady=2,text="SUMAN BILLING SYSTEM",bd=12,bg=bg_color,fg='blue',font=('times new roman', 25 ,'bold'),relief=GROOVE,justify=CENTER)
title.pack(fill=X)

#=================Product Frames========By>>Suman007lod=========
